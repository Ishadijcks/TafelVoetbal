...
def test_serialize_calibrate():
    ...
    assert serialized == bytes([0xFF, 0x01, 0x01, 0x00])
...
def test_serialize_translate_zero():
    ...
    serialized = command.serialize()
    assert serialized == bytes([0xFF, 0x02, 0x04, 0x00])
...
def test_serialize_translate_one():
    ...
    serialized = command.serialize()
    assert serialized == bytes([0xFF, 0x02, 0x04, 0xFE])
...
def test_serialize_translate_half():
    ...
    serialized = command.serialize()
    assert serialized == bytes([0xFF, 0x02, 0x03, 0x7F])
...
def test_serialize_rotate_zero():
    ...
    serialized = command.serialize()
    assert serialized == bytes([0xFF, 0x03, 0x02, 0x00])
...
def test_serialize_rotate_one():
    ...
    serialized = command.serialize()
    assert serialized == bytes([0xFF, 0x03, 0x04, 0xFE])
...
def test_serialize_rotate_half():
    ...
    serialized = command.serialize()
    assert serialized == bytes([0xFF, 0x03, 0x01, 0x7F])
